...
<div id="container" >
    ...
    <form:form commandName="advert" method="post" action="${pageContext.request.contextPath}save" role="form">
        ...
        <div id="box4"> Kategoria: <form:select path="id_kategoria"><form:options items="${id_kategoria}" itemValue="id_kategoria"
        ...
        Forma zatrudnienia: <form:select path="id_forma_zatrudnienia"><form:options items="${id_forma_zatrudnienia}"
                                                                                    itemValue="id_forma_zatrudnienia" itemLabel="nazwa"/></form:select>
        </div>
        <div id="box4">
